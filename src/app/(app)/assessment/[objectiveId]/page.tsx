              ...
              <div>
                <label className="flex items-center text-sm font-medium text-dark-muted mb-1">
                  ...
                  <InfoBubble title="How to assess your hip mobility">
                    ...
                    <p><span className="font-bold text-burnt-orange">2</span> <span className="font-semibold">(Tight):</span> You can sit cross-legged but not for long. Lunges feel tight in the front of your back hip. You occasionally stretch or do yoga but your hips are noticeably stiff, especially after sitting for hours.</p>
                    <p><span className="font-bold text-burnt-orange">3</span> <span className="font-semibold">(Average):</span> You can do a deep lunge and hold it. Sitting cross-legged is fine. You don&apos;t have a dedicated flexibility routine, but you move regularly and your hips don&apos;t limit your activities. Most active people are here.</p>
                    <p><span className="font-bold text-burnt-orange">4</span> <span className="font-semibold">(Pretty flexible):</span> You can easily hold a deep lunge with your back knee an inch from the ground. Pigeon pose and similar hip stretches feel comfortable. You probably do yoga or dedicated mobility work at least once a week.</p>
              ...
              <div>
                <label className="flex items-center text-sm font-medium text-dark-muted mb-1">
                  ...
                  <InfoBubble title="How to assess your ankle mobility">
                    ...
                    <p><span className="font-bold text-burnt-orange">1</span> <span className="font-semibold">(Very stiff):</span> You can&apos;t touch your knee to the wall from 4 inches. Deep squats force your heels off the ground. You&apos;ve had ankle sprains or wear stiff shoes most of the time. Going downhill on steep trails feels jarring.</p>
                    <p><span className="font-bold text-burnt-orange">2</span> <span className="font-semibold">(Stiff):</span> Knee barely touches the wall at 4 inches. Squatting deep requires heel elevation or a wide stance. You notice ankle tightness on steep descents or uneven ground. Calves feel chronically tight.</p>
                    <p><span className="font-bold text-burnt-orange">3</span> <span className="font-semibold">(Average):</span> You pass the wall test at 4 inches without difficulty. You can squat to parallel with heels down. Steep terrain doesn&apos;t bother your ankles specifically. Most people who walk or run regularly are here.</p>
